...
// --- MODIFICACIÓN 1: Importamos los componentes necesarios para los modales ---
...
// NOTA: Se eliminó la constante 'faqDataBySection' de aquí afuera
// para moverla dentro del componente y tener acceso a las funciones de estado.

export default function FaqPage() {
  const { setTitle } = useHeader();
  const [openSection, setOpenSection] = useState<string>('');

  // --- MODIFICACIÓN 2: Estados para controlar la apertura de los Popups ---
  ...
  // --- MODIFICACIÓN 3: Definimos los datos DENTRO del componente ---
  // Esto permite insertar los onClick handlers en el JSX de las respuestas.
        ...
        },
        {
          ...
          answer: (
            <span>
              ...
              {/* --- AQUÍ: Cambio de strong por button interactivo --- */}
              <button
        ...
        },
        {
          ...
          answer: (
            <span>
              ...
              {/* --- AQUÍ: También actualizamos este, por consistencia --- */}
              <button
                onClick={() => setIsTermsOpen(true)}
  ...
  return (
    <>
      ...
      {/* --- MODIFICACIÓN 4: Renderizado de los Popups --- */}
      <LegalPopup
        isOpen={isTermsOpen}
