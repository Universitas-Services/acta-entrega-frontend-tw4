      ...
      },
      {
        ...
        answer: (
          <span>
            ...
            rápidas, la App no sustituye el juicio de un profesional del derecho
            para estrategias legales o defensa en procedimientos
            administrativos.
          </span>
        ),
      },
    ...
    items: [
      {
        ...
        answer: {
          ...
          points: [
            <span key="0">
              <strong>Edición ilimitada:</strong> Guarda borradores y edita tus
              actas en el panel de actas cuantas veces quieras.
            </span>,
            <span key="1">
              <strong>Módulo de Compliance:</strong> Un reporte en{' '}
              <strong>PDF</strong> que te alerta sobre omisiones o fallas según
              la ley.
            </span>,
            <span key="2">
      ...
      },
      {
        ...
        answer: (
          <span>
            ...
            escrito dentro de las primeras 24 horas posteriores al pago, siempre
            y cuando el usuario no haya utilizado la herramienta para generar
            actas ni haya hecho uso del módulo de Compliance. Una vez consumido
            el servicio principal, no aplican reembolsos. Puedes ampliar esta
            información consultando nuestros{' '}
      ...
      },
      {
        ...
        answer: (
          <span>
            ...
            <strong>asesoría personalizada</strong> con uno de nuestros expertos
            a través de WhatsApp o al correo{' '}
                  ...
                  {section.items.map((item, index) => (
                    <div key={index}>
                      ...
                      <div className="mt-2 text-muted-foreground leading-relaxed">
                        ...
                        'points' in (item.answer as { points?: unknown }) ? (
                          // Renderizar objeto con lista de puntos
                          <div className="space-y-2">
                            {(item.answer as { intro?: string }).intro && (
                              <p>{(item.answer as { intro?: string }).intro}</p>
                            )}
